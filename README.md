...
## Decision-making pipeline of business & IT alignment
|   | Phase 1 | Phase 2 | Phase 3 | Phase 4 | Phase 5 |
| --- | --- |--- |--- |--- |--- |
| Title  | Positioning | Focusing | Prioritizing | Assessing | Implementing |
| Meaning  | Setting an overall context for alignment |  Defining a direction for future IT investment | Shaping a detailed IT investment portfolio | Elaborating & evaluating IT initiatives | Producing detailed implementation plans |
| Involved Actors  | C-level business & IT executives | Senior business & IT leaders| Local business & IT Managers | Business Sponsors & IT architects | Business Analysts & IT project teams |
| Decisions  | How our company needs to work | Where our company needs to invest | What IT initiatives needs to be executed | How to implement each IT initiative conceptually | How to deliver each IT initiative technically  |
| Typical Deliverables | Princples |  Business Capability Map | Investment roadmaps | Solution Overviews | Solution Design |
| Quantity  | One set | One document| Several documents | Multiple documents | Multiple documents |
| Scope  | Entire Organization | Entire Organization | Seperate business units | Specific IT initiatives | Specific IT projects |
| Horizon  | Largely timeless | 3-5 years | 2-3 years | 1-2 years | 6-12 months |
| Granularity  | General Considerations | Business capabilties | Specific business needs | Solution structure | System Components |
| Outcomes  | Overall Appropriateness | Strategic Effectiveness| Mid-Term Expediency | Tatical Efficiency | Fitness to Requirements |
| Alignment  | Strategic Alignment | Strategic Alignment | Strategic Alignment | Operational Alignment | Operational Alignment |
...
, and Technology Optimization. These three processes are carried out simulataneously by different actors and interrelated with each other. Each of these processes implies developing and using specific types of EA artifacts. 
